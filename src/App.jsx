  ...
  return (
    <div className="relative flex bg-background min-h-screen selection:bg-primary/30 overflow-hidden">
      ...
      {activeSong?.attributes && (
        <div className="absolute h-28 md:h-32 bottom-0 left-0 right-0 flex animate-slideup bg-slate-950/90 backdrop-blur-3xl border-t border-white/5 z-[100] shadow-[0_-20px_80px_rgba(139,92,246,0.15)]">
          <MusicPlayer />
        </div>
      )}
